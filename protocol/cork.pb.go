...
type VolumesToMountGetRequest struct {
}

func (m *VolumesToMountGetRequest) Reset()                    { *m = VolumesToMountGetRequest{} }
func (m *VolumesToMountGetRequest) String() string            { return proto.CompactTextString(m) }
func (*VolumesToMountGetRequest) ProtoMessage()               {}
func (*VolumesToMountGetRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (*VolumesToMountGetResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
func (*StageExecuteRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
func (*EventReactRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }
...
func init() {
	...
	proto.RegisterType((*VolumesToMountGetRequest)(nil), "VolumesToMountGetRequest")
...
type CorkTypeServiceClient interface {
	...
	VolumesToMountGet(ctx context.Context, in *VolumesToMountGetRequest, opts ...grpc.CallOption) (*Response, error)
...
func (c *corkTypeServiceClient) VolumesToMountGet(ctx context.Context, in *VolumesToMountGetRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := grpc.Invoke(ctx, "/CorkTypeService/VolumesToMountGet", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CorkTypeServiceServer interface {
	...
	// Gets the configuration of volumes to mount for this cork server
	VolumesToMountGet(context.Context, *VolumesToMountGetRequest) (*Response, error)
	// Executes a specific stage
...
func _CorkTypeService_VolumesToMountGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VolumesToMountGetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CorkTypeServiceServer).VolumesToMountGet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CorkTypeService/VolumesToMountGet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CorkTypeServiceServer).VolumesToMountGet(ctx, req.(*VolumesToMountGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CorkTypeService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VolumesToMountGet",
			Handler:    _CorkTypeService_VolumesToMountGet_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
